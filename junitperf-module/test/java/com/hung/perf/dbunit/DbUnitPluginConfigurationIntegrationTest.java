...
public class DbUnitPluginConfigurationIntegrationTest  {

    private static Logger log = Logger.getLogger(DbUnitPluginConfigurationIntegrationTest.class);
